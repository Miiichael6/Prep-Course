...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  let estaoNo = array.includes(elemento);
  return estaoNo;
}
...
function promedioResultadosTest(resultadosTest) {
  ...
  let final = acumulador / resultadosTest.length;
  return final;
}
...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
  let mayorNumber = Math.max(...numeros)
  return mayorNumber
}
...
function cuentoElementos(arreglo) {
  ...
  //Escribe tu código aquí
  let filtrados = arreglo.filter(a => a > 18)
